...
public class AcoAlgorithmMorePheromoneWhenBetterSolution extends AcoAlgorithm {
     ...
     */
    public AcoAlgorithmMorePheromoneWhenBetterSolution(Cities cities, int pheromoneAmount, int numAnts,
            int numIterations,
